...
var createElement = function createElement(type) {
  ...
  Object.keys(attributes || {}).forEach(function (key) {
    ...
    }) : key !== "style" ? key === "className" ? element.setAttribute('class', attributes[key]) : element.setAttribute(key, attributes[key]) : element[key] = attributes[key];
  });
...
var renderToDom = function renderToDom(element, props, container, olDom) {
